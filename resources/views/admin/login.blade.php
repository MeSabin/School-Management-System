...
<body class="tw-flex tw-items-center tw-justify-center tw-min-h-screen tw-bg-gray-100">
  ...
  <div class="tw-bg-white tw-px-5 tw-pb-5 tw-pt-2 tw-rounded-xl tw-shadow-custom ">
    <h2 class="tw-text-xl tw-text-center tw-font-bold tw-mb-3 tw-text-purple-600">Login as Admin</h2>
      ...
      <div class="">
        ...
        <div class="tw-flex tw-items-center tw-justify-between tw-mt-5 tw-mb-5">
          ...
          <div class="tw-flex tw-justify-between ">
            <a href="{{route('adminForgotPass')}}" class="tw-text-sm tw-text-purple-500 tw-hover:underline tw-inline-block" >Forgot password?</a>
          </div>
      </div>
      <button
        type="submit"
