      ...
      <nav class="tw-mt-4">
        <ul>
          ...
          <li>
            ...
            <li>
              <a href="{{route('logoutTeacher')}}" class="tw-flex tw-py-3 tw-mt-60 tw-mb-1 tw-px-3 tw-rounded-md hover:tw-bg-gray-200 tw-duration-300">
        ...
        <div class="tw-flex tw-flex-row tw-items-center tw-justify-between">
          ...
          <div class="tw-flex tw-items-center tw-mr-6">
            ...
            <div id="imgDiv" class="tw-flex tw-items-center tw-space-x-2">
              ...
              <img src="{{ asset('/uploads/'. $image) }}" id="profilePic" class="tw-w-10 tw-h-10 tw-cursor-pointer tw-rounded-full tw-border tw-text-start" alt="Image"/>
            </div>
          </div>
        </div>
      </header>
...
<div id="" class="profilePopup tw-bg-white tw-shadow-custom tw-fixed tw-right-10 tw-top-20 tw-px-3 tw-pt-4 tw-pb-3 tw-rounded-xl tw-transition-transform tw-duration-1000 tw-z-20">
  <div class="tw-flex tw-items-center tw-mb-4">
    <img src="{{ asset('/uploads/'. $image) }}" class="tw-w-9 tw-rounded-full tw-border tw-text-start" alt="Image"/>
    <div>
  ...
  <ul>
    ...
    <li class="tw-py-1.5 tw-flex tw-items-center tw-hover:bg-gray-200 tw-pl-1 tw-rounded-lg tw-duration-500">
      ...
      <a href="{{route('logoutTeacher')}}" class="tw-text-rose-500 tw-font-semibold tw-text-sm">Logout</a>
    </li>
  </ul>
</div>
