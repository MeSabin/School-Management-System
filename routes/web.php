...
Route::prefix('admin')->group(function() {
   ...
   Route::view('/teachersList','admin/viewTeachers')->name('teachersList')->middleware(validAdmin::class);
   Route::view('/registerTeacher','admin/registerTeacher')->name('registerTeacher')->middleware(validAdmin::class);
